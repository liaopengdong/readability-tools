const TOOLS = {"readability-score": {"title": "Readability Score Calculator", "desc": "Estimate Flesch reading ease and grade level.", "category": "Scores", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Clear writing helps readers understand ideas quickly. Short sentences are usually easier to read."}], "manual": false}, "sentence-length-checker": {"title": "Sentence Length Checker", "desc": "Find average and longest sentence length.", "category": "Structure", "kind": "sentencesTool", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This is a short sentence. This second sentence is a little longer and gives more detail."}], "manual": false}, "passive-voice-checker": {"title": "Passive Voice Highlighter", "desc": "Estimate passive voice patterns using common be-verb signals.", "category": "Editing", "kind": "passive", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "The report was written by the team. We reviewed the result."}], "manual": false}, "paragraph-length-checker": {"title": "Paragraph Length Checker", "desc": "Check paragraph word counts and long paragraph risk.", "category": "Structure", "kind": "paragraphs", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "First paragraph with a few words.\n\nSecond paragraph with more words for testing readability."}], "manual": false}, "reading-level-estimator": {"title": "Reading Level Estimator", "desc": "Estimate reading level from sentence and word complexity.", "category": "Scores", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This tool estimates readability from simple language signals."}], "manual": false}, "plain-english-checker": {"title": "Plain English Checker", "desc": "Flag long words, long sentences, and complex wording.", "category": "Editing", "kind": "plainEnglish", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Utilize this functionality to facilitate improved communication outcomes."}], "manual": false}, "reading-time-calculator": {"title": "Reading Time Calculator", "desc": "Estimate reading and speaking time.", "category": "Timing", "kind": "readTime", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Paste article text here."}, {"id": "wpm", "label": "Reading WPM", "type": "number", "value": 200}], "manual": false}, "keyword-frequency-checker": {"title": "Keyword Frequency Checker", "desc": "Count keyword frequency and density.", "category": "Scores", "kind": "keyword", "fields": [{"id": "keyword", "label": "Keyword", "type": "text", "value": "tools"}, {"id": "text", "label": "Text", "type": "textarea", "value": "Tools help people work faster. Good tools are focused."}], "manual": false}, "duplicate-word-checker": {"title": "Duplicate Word Checker", "desc": "Find repeated adjacent words.", "category": "Editing", "kind": "duplicateWords", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This is is a simple simple test."}], "manual": false}, "syllable-estimator": {"title": "Syllable Estimator", "desc": "Estimate syllables in text.", "category": "Scores", "kind": "syllables", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Readability tools estimate sentence complexity."}], "manual": false}, "summary-length-checker": {"title": "Summary Length Checker", "desc": "Check whether a summary fits a target length.", "category": "Structure", "kind": "summaryLength", "fields": [{"id": "text", "label": "Summary", "type": "textarea", "value": "A short summary of the article."}, {"id": "target", "label": "Target characters", "type": "number", "value": 160}], "manual": false}, "transition-word-checker": {"title": "Transition Word Checker", "desc": "Count common transition words.", "category": "Editing", "kind": "transitions", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "First, we checked the input. However, the result still needed review."}], "manual": false}, "word-count-checker": {"title": "Word Count Checker", "desc": "Count words and readability signals for drafts, posts, and documentation.", "category": "Scores", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Clear writing helps readers understand important ideas quickly."}], "manual": false}, "long-sentence-checker": {"title": "Long Sentence Checker", "desc": "Find average and longest sentence length to improve scan-friendly writing.", "category": "Structure", "kind": "sentencesTool", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This sentence is short. This sentence is intentionally longer because it shows how quickly a draft can become harder to read when too many details are included at once."}], "manual": false}, "blog-reading-time-calculator": {"title": "Blog Reading Time Calculator", "desc": "Estimate reading and speaking time for articles, posts, and scripts.", "category": "Timing", "kind": "readTime", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Paste blog post text here."}, {"id": "wpm", "label": "Reading WPM", "type": "number", "value": 225}], "manual": false}, "meta-summary-length-checker": {"title": "Meta Summary Length Checker", "desc": "Check whether a short summary fits a target character length.", "category": "Structure", "kind": "summaryLength", "fields": [{"id": "text", "label": "Summary", "type": "textarea", "value": "Fast browser-based tools for practical everyday workflows."}, {"id": "target", "label": "Target characters", "type": "number", "value": 155}], "manual": false}, "keyword-density-checker": {"title": "Keyword Density Checker", "desc": "Count exact keyword frequency and density in a text sample.", "category": "Scores", "kind": "keyword", "fields": [{"id": "keyword", "label": "Keyword", "type": "text", "value": "calculator"}, {"id": "text", "label": "Text", "type": "textarea", "value": "A calculator should solve a specific calculation clearly."}], "manual": false}, "plain-language-checker": {"title": "Plain Language Checker", "desc": "Flag long words and estimate average word length for clearer writing.", "category": "Editing", "kind": "plainEnglish", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Implement this functionality to facilitate improved user comprehension."}], "manual": false}, "repeated-word-finder": {"title": "Repeated Word Finder", "desc": "Find repeated adjacent words that often slip into drafts.", "category": "Editing", "kind": "duplicateWords", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "We will will review the final final draft."}], "manual": false}, "paragraph-word-count-checker": {"title": "Paragraph Word Count Checker", "desc": "Check paragraph count, longest paragraph length, and long paragraph risk.", "category": "Structure", "kind": "paragraphs", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Short paragraph.\n\nA longer paragraph can become hard to scan when it includes too many ideas without breaks."}], "manual": false}, "advanced-readability-score": {"title": "Advanced Readability Score Calculator", "desc": "Estimate Flesch reading ease and grade level. Use this focused variant for advanced workflows and long-tail search scenarios.", "category": "Scores", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Clear writing helps readers understand ideas quickly. Short sentences are usually easier to read."}], "manual": false}, "quick-sentence-length-checker": {"title": "Quick Sentence Length Checker", "desc": "Find average and longest sentence length. Use this focused variant for quick workflows and long-tail search scenarios.", "category": "Structure", "kind": "sentencesTool", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This is a short sentence. This second sentence is a little longer and gives more detail."}], "manual": false}, "planning-passive-voice-checker": {"title": "Planning Passive Voice Highlighter", "desc": "Estimate passive voice patterns using common be-verb signals. Use this focused variant for planning workflows and long-tail search scenarios.", "category": "Editing", "kind": "passive", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "The report was written by the team. We reviewed the result."}], "manual": false}, "mobile-paragraph-length-checker": {"title": "Mobile Paragraph Length Checker", "desc": "Check paragraph word counts and long paragraph risk. Use this focused variant for mobile workflows and long-tail search scenarios.", "category": "Structure", "kind": "paragraphs", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "First paragraph with a few words.\n\nSecond paragraph with more words for testing readability."}], "manual": false}, "small-business-reading-level-estimator": {"title": "Small Business Reading Level Estimator", "desc": "Estimate reading level from sentence and word complexity. Use this focused variant for small business workflows and long-tail search scenarios.", "category": "Scores", "kind": "readability", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This tool estimates readability from simple language signals."}], "manual": false}, "creator-plain-english-checker": {"title": "Creator Plain English Checker", "desc": "Flag long words, long sentences, and complex wording. Use this focused variant for creator workflows and long-tail search scenarios.", "category": "Editing", "kind": "plainEnglish", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Utilize this functionality to facilitate improved communication outcomes."}], "manual": false}, "student-reading-time-calculator": {"title": "Student Reading Time Calculator", "desc": "Estimate reading and speaking time. Use this focused variant for student workflows and long-tail search scenarios.", "category": "Timing", "kind": "readTime", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Paste article text here."}, {"id": "wpm", "label": "Reading WPM", "type": "number", "value": 200}], "manual": false}, "team-keyword-frequency-checker": {"title": "Team Keyword Frequency Checker", "desc": "Count keyword frequency and density. Use this focused variant for team workflows and long-tail search scenarios.", "category": "Scores", "kind": "keyword", "fields": [{"id": "keyword", "label": "Keyword", "type": "text", "value": "tools"}, {"id": "text", "label": "Text", "type": "textarea", "value": "Tools help people work faster. Good tools are focused."}], "manual": false}, "audit-duplicate-word-checker": {"title": "Audit Duplicate Word Checker", "desc": "Find repeated adjacent words. Use this focused variant for audit workflows and long-tail search scenarios.", "category": "Editing", "kind": "duplicateWords", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "This is is a simple simple test."}], "manual": false}, "checklist-syllable-estimator": {"title": "Checklist Syllable Estimator", "desc": "Estimate syllables in text. Use this focused variant for checklist workflows and long-tail search scenarios.", "category": "Scores", "kind": "syllables", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Readability tools estimate sentence complexity."}], "manual": false}, "campaign-summary-length-checker": {"title": "Campaign Summary Length Checker", "desc": "Check whether a summary fits a target length. Use this focused variant for campaign workflows and long-tail search scenarios.", "category": "Structure", "kind": "summaryLength", "fields": [{"id": "text", "label": "Summary", "type": "textarea", "value": "A short summary of the article."}, {"id": "target", "label": "Target characters", "type": "number", "value": 160}], "manual": false}, "batch-transition-word-checker": {"title": "Batch Transition Word Checker", "desc": "Count common transition words. Use this focused variant for batch workflows and long-tail search scenarios.", "category": "Editing", "kind": "transitions", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "First, we checked the input. However, the result still needed review."}], "manual": false}};
